    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">         
           <ul class="timeline">
           		<?php
           			$q = mysqli_query($con,"select * from tblblog order by fldTimePosted DESC");
           			$carID = 0;
           			...
           			<li>
           				...
           				<div class="timeline-item">
				            ...
				            <div class="timeline-body" style="font-weight: normal;">
				            	...
				            	<div class="row">
				            	 ...
				            	 <div class="box box-solid">
						            ...
						            <div class="box-body col-sm-6">
						                <?php
						                    $v = mysqli_query($con,"select * from tblblogpic where fldBlogID = '$blogID'");
						                ...
						                <div class="carousel-inner">
							                  ...
							                  ?>
							                  		<div class="item <?php if($vID2 == 0) { echo "active"; } ?>">
									                	<img style="height:350px !important" width="100%" src="../images/blog/<?php echo $vf['fldPicture'] ?>">
									                </div>
					            ...
					            <?php
				            		$c = mysqli_query($con,"select * from tblblogpic where fldBlogID = '$blogID'");
			            	...
			            	<div class="timeline-footer">
				                ...
				                <a href="?p=editBlog&blogID=<?php echo $blogID ?>" id="editBtn" class="btn btn-primary btn-xs">Edit</a>
				                <a href="?p=deleteBlog&blogID=<?php echo $blogID ?>" onclick="return confirm('Are you sure you want to delete this blog entry? Changes cannot be reverted.')" id="deleteBtn" class="btn btn-danger btn-xs">Delete</a>
				            </div>
