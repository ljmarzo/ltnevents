			 ...
			 $(document).ready(function(){
               ...
               $("#confirmEye").mouseup(function(){
                ...
                $('#uname').blur(function()
        		{
        			...
        			$.post('checkusername.php', { uname: uname },
        			function(result){
        				$('#unamehint').html(result).show();
        				if(result=='Username unavailable')
        				{
        					//$('#hiddenchecker').val('unavail');
        				}
        				else
        				{
        					//$('#hiddenchecker').val('');
        					$('#unamehint').removeClass('badge-danger');
        					$('#unamehint').addClass('badge-success');
        				}
        			});
        		});
            });
...
<div class="container">
<h1>This is a test page. Do not use</h1>
<br>
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="form-group col-sm-12 col-md-12 col-xs-12">
						<b><label>Username* (6-20 characters)</label></b>&emsp;<label id="unamehint" class="badge badge-danger">a</label>
