<?php
      $zxc = mysqli_query($con,"select * from tblpageviews where fldPage = 'blog'");
      $zxcf = mysqli_fetch_array($zxc);
      $views = $zxcf['fldViews'];
      $views = $views +1;
      $zxc = mysqli_query($con,"update tblpageviews set fldViews = '$views' where fldPage = 'blog'");
    ?>
    ...
    <br>
      ...
      ?>
              <div class="card bg-1st" style="padding:12px">
                ...
                <h4 class="card-title"><strong><?php echo $qf['fldTitle'] ?></strong></h4>
              ...
              $x = mysqli_query($con,"select * from tblblogpic where fldBlogID = '$blogID'");
                       ...
                       <?php
                        ...
                        ?>
                            <div class="carousel-item <?php if($vID2 == 0) { echo "active"; } ?>">
                              <img class="d-block w-100" height="auto" max-width="40%" src="images/blog/<?php echo $vf['fldPicture'] ?>">
                            </div>
